...
class NanoVectorDBStorage(BaseVectorStorage):
    ...
    def __post_init__(self):
        ...
        # --- [关键修复] 强制定义需要存储的元数据字段 ---
        # 这样向量库就会把 entity_name 和 hyperedge_name 存下来，而不只是存 ID
        self.meta_fields = {"content", "entity_name", "hyperedge_name", "src_id", "tgt_id"}
        # --------------------------------------------
    ...
    async def query(self, query: str, top_k=5):
        ...
        # 结果中现在会包含 entity_name / hyperedge_name
        results = [
